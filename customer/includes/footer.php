...
<img style="height: 50px;" class="img img-responsive" src="images/site1.png" alt="logo" title="Kandurata Flower Nursery" />
<br />
...
<?php 
           ...
           if(!isset($_SESSION['customer_email'])){
            ...
            echo "<a class='text-muted' style='text-decoration: none;' href='#'>Login</a>";

           } else{

            echo"<a class='text-muted' style='text-decoration: none;' href='#'>My Account</a>";
...
<p>
<a class="text-muted" style="text-decoration: none;" href="#">Register</a>
</p>
</div>
